 ...
 */
abstract class Magecheckout_Facebook_BaseFacebook
{
    /**
     * Version.
     */
    ...
    protected function getUserFromAccessToken()
    {
        try {
            ...
            return $user_info['id'];
        } catch (Magecheckout_Facebook_ApiException $e) {
            return 0;
        }
    }
     ...
     * @throws Magecheckout_Facebook_ApiException
     */
    protected function _restserver($params)
    {
        ...
        if (is_array($result) && isset($result['error_code'])) {
            throw new Magecheckout_Facebook_ApiException($result);
        }
    ...
    protected function makeRequest($url, $params, $ch = null)
    {
        ...
        if ($result === false) {
            $e = new Magecheckout_Facebook_ApiException(array(
    ...
    {
        $e = new Magecheckout_Facebook_ApiException($result);
        switch ($e->getType()) {
